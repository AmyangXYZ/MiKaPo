...
// plain 2D canvas. Its job is blame assignment: when the character looks wrong
// here too, the model did it; when this looks right, the solver did. Drag to
// orbit — depth errors are invisible from the front, and depth is exactly
...
// MediaPipe 33-point pose topology.
